mpirun -np 2 -env OMP_NUM_THREADS=1 ./diag --fcidump fcidump_Fe4S4.txt --adetfile AlphaDets.txt \
       --method 0 --block 10 --iteration 1 --tolerance 1.0e-2 \
       --adet_comm_size 2 --bdet_comm_size 1 --task_comm_size 1 \
